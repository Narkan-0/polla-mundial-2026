...
def obtener_fixture_completo():
    return [
        ...
        {"id": 76, "fase_bloque": "Fases Finales", "grupo": "Dieciseisavos", "fecha_ref": "2026-06-29 21:00", "fecha": "29 de Junio", "hora": "21:00", "local": "PAÍSES BAJOS", "flag_l": "🇳🇱", "visita": "MARRUECOS", "flag_v": "🇲🇦", "estadio": "Monterrey"},
        {"id": 77, "fase_bloque": "Fases Finales", "grupo": "Dieciseisavos", "fecha_ref": "2026-06-30 13:00", "fecha": "30 de Junio", "hora": "13:00", "local": "COSTA DE MARFIL", "flag_l": "🇨🇮", "visita": "NORUEGA", "flag_v": "🇳🇴", "estadio": "Dallas"},
        {"id": 78, "fase_bloque": "Fases Finales", "grupo": "Dieciseisavos", "fecha_ref": "2026-06-30 17:00", "fecha": "30 de Junio", "hora": "17:00", "local": "FRANCIA", "flag_l": "🇫🇷", "visita": "SUECIA", "flag_v": "🇸🇪", "estadio": "N. York/N. Jersey"},
        {"id": 79, "fase_bloque": "Fases Finales", "grupo": "Dieciseisavos", "fecha_ref": "2026-06-30 21:00", "fecha": "30 de Junio", "hora": "21:00", "local": "MÉXICO", "flag_l": "🇲🇽", "visita": "ECUADOR", "flag_v": "🇪🇨", "estadio": "Ciudad de México"},
        {"id": 80, "fase_bloque": "Fases Finales", "grupo": "Dieciseisavos", "fecha_ref": "2026-07-01 12:00", "fecha": "01 de Julio", "hora": "12:00", "local": "INGLATERRA", "flag_l": "\U0001F3F4\U000E0067\U000E0062\U000E0065\U000E006E\U000E0067\U000E007F", "visita": "RD CONGO", "flag_v": "🇨🇩", "estadio": "Atlanta"},
        {"id": 81, "fase_bloque": "Fases Finales", "grupo": "Dieciseisavos", "fecha_ref": "2026-07-01 16:00", "fecha": "01 de Julio", "hora": "16:00", "local": "BÉLGICA", "flag_l": "🇧🇪", "visita": "SENEGAL", "flag_v": "🇸🇳", "estadio": "Seattle"},
        {"id": 82, "fase_bloque": "Fases Finales", "grupo": "Dieciseisavos", "fecha_ref": "2026-07-01 20:00", "fecha": "01 de Julio", "hora": "20:00", "local": "ESTADOS UNIDOS", "flag_l": "🇺🇸", "visita": "BOSNIA Y HERZEG.", "flag_v": "🇧🇦", "estadio": "San Francisco"},
        {"id": 83, "fase_bloque": "Fases Finales", "grupo": "Dieciseisavos", "fecha_ref": "2026-07-02 15:00", "fecha": "02 de Julio", "hora": "15:00", "local": "ESPAÑA", "flag_l": "🇪🇸", "visita": "AUSTRIA", "flag_v": "🇦🇹", "estadio": "Los Angeles"},
        {"id": 84, "fase_bloque": "Fases Finales", "grupo": "Dieciseisavos", "fecha_ref": "2026-07-02 19:00", "fecha": "02 de Julio", "hora": "19:00", "local": "PORTUGAL", "flag_l": "🇵🇹", "visita": "CROACIA", "flag_v": "🇭🇷", "estadio": "Toronto"},
        {"id": 85, "fase_bloque": "Fases Finales", "grupo": "Dieciseisavos", "fecha_ref": "2026-07-02 23:00", "fecha": "02 de Julio", "hora": "23:00", "local": "SUIZA", "flag_l": "🇨🇭", "visita": "ARGELIA", "flag_v": "🇩🇿", "estadio": "Vancouver"},
        {"id": 86, "fase_bloque": "Fases Finales", "grupo": "Dieciseisavos", "fecha_ref": "2026-07-03 14:00", "fecha": "03 de Julio", "hora": "14:00", "local": "AUSTRALIA", "flag_l": "🇦🇺", "visita": "EGIPTO", "flag_v": "🇪🇬", "estadio": "Dallas"},
        ...
        # --- OCTAVOS DE FINAL (RE-CABLEADOS MATEMÁTICAMENTE PARA LOS CRUCES PERFECTOS DE LA FIFA) ---
        {"id": 89, "fase_bloque": "Fases Finales", "grupo": "Octavos", "fecha_ref": "2026-07-04 17:00", "fecha": "04 de Julio", "hora": "17:00", "local": "GANADOR P75", "flag_l": "🥇", "visita": "GANADOR P78", "flag_v": "🥇", "estadio": "Filadelfia"},
        {"id": 90, "fase_bloque": "Fases Finales", "grupo": "Octavos", "fecha_ref": "2026-07-04 13:00", "fecha": "04 de Julio", "hora": "13:00", "local": "GANADOR P73", "flag_l": "🥇", "visita": "GANADOR P76", "flag_v": "🥇", "estadio": "Houston"},
        {"id": 91, "fase_bloque": "Fases Finales", "grupo": "Octavos", "fecha_ref": "2026-07-05 16:00", "fecha": "05 de Julio", "hora": "16:00", "local": "GANADOR P74", "flag_l": "🥇", "visita": "GANADOR P77", "flag_v": "🥇", "estadio": "N. York/N. Jersey"},
        ...
        {"id": 93, "fase_bloque": "Fases Finales", "grupo": "Octavos", "fecha_ref": "2026-07-06 15:00", "fecha": "06 de Julio", "hora": "15:00", "local": "GANADOR P84", "flag_l": "🥇", "visita": "GANADOR P83", "flag_v": "🥇", "estadio": "Dallas"},
        ...
        {"id": 95, "fase_bloque": "Fases Finales", "grupo": "Octavos", "fecha_ref": "2026-07-07 12:00", "fecha": "07 de Julio", "hora": "12:00", "local": "GANADOR P87", "flag_l": "🥇", "visita": "GANADOR P86", "flag_v": "🥇", "estadio": "Atlanta"},
        {"id": 96, "fase_bloque": "Fases Finales", "grupo": "Octavos", "fecha_ref": "2026-07-07 16:00", "fecha": "07 de Julio", "hora": "16:00", "local": "GANADOR P85", "flag_l": "🥇", "visita": "GANADOR P88", "flag_v": "🥇", "estadio": "Vancouver"},

        # --- CUARTOS DE FINAL (HORARIOS CORREGIDOS A HORA DE CHILE) ---
        ...
        {"id": 98, "fase_bloque": "Fases Finales", "grupo": "Cuartos", "fecha_ref": "2026-07-10 18:00", "fecha": "10 de Julio", "hora": "18:00", "local": "GANADOR P93", "flag_l": "🥇", "visita": "GANADOR P94", "flag_v": "🥇", "estadio": "Los Angeles"},
        {"id": 99, "fase_bloque": "Fases Finales", "grupo": "Cuartos", "fecha_ref": "2026-07-11 17:00", "fecha": "11 de Julio", "hora": "17:00", "local": "GANADOR P91", "flag_l": "🥇", "visita": "GANADOR P92", "flag_v": "🥇", "estadio": "Miami"},
        ...
        {"id": 101, "fase_bloque": "Fases Finales", "grupo": "Semifinales", "fecha_ref": "2026-07-14 16:00", "fecha": "14 de Julio", "hora": "16:00", "local": "GANADOR P97", "flag_l": "🥇", "visita": "GANADOR P98", "flag_v": "🥇", "estadio": "Dallas"},
...
with tabs[0]:
    ...
    premio_2 = int(round((fondo_total * 0.333) / 1000) * 1000)
    premio_3 = int(round((fondo_total * 0.166) / 1000) * 1000)
    
    with c_p1: st.markdown(f"<div style='background:rgba(34,197,94,0.15);padding:15px;border-radius:10px;border:1px solid #22c55e;text-align:center;'><span>🥇 1er Lugar</span><br><strong style='font-size:1.6rem;color:#fbbf24;'>{df_tabla.iloc[0]['Participante'].upper()}</strong><br><span>${premio_1:,.0f}</span></div>", unsafe_allow_html=True)
    with c_p2: st.markdown(f"<div style='background:rgba(234,179,8,0.1);padding:15px;border-radius:10px;border:1px solid #eab308;text-align:center;'><span>🥈 2do Lugar</span><br><strong style='font-size:1.4rem;color:#e2e8f0;'>{df_tabla.iloc[1]['Participante'].upper()}</strong><br><span>${premio_2:,.0f}</span></div>", unsafe_allow_html=True)
    with c_p3: st.markdown(f"<div style='background:rgba(239,68,68,0.1);padding:15px;border-radius:10px;border:1px solid #ef4444;text-align:center;'><span>🥉 3er Lugar</span><br><strong style='font-size:1.4rem;color:#e2e8f0;'>{df_tabla.iloc[2]['Participante'].upper()}</strong><br><span>${premio_3:,.0f}</span></div>", unsafe_allow_html=True)
